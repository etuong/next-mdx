...
metaDesc: Machine Learning is defined as the capability of a machine to imitate intelligent human behavior
---
...
Cleaning data throws away the bad data.
1. Scaling helps gradient descent to converge more quickly because the range of focus is more narrow.
1. Handle extreme outliers. Using a log scale graph helps with this visual.
1. Other techniques include binning and scrubbing.
